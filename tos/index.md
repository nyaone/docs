...
- 我们可能会采取一些技术手段以尽量减少可能出现的骚扰或污染等滥用内容，但因 fediverse 本身的特性所限，无法做到完全杜绝。
...
我们 **不会** 以任何理由向您索要包括但不仅限于您的真实身份、使用设备、密码、 IP 详细地址、电子邮箱、 API Token 、邀请码和会话密钥等任何隐私信息。请保护好您的这些隐私数据，谨防诈骗，避免对您的人身或财产安全造成损失。
...
已经观察到有实例遭受了来自诈骗团伙的攻击，其伪装成实例官方身份诱骗相关用户前往恶意网站地址输入银行卡信息，请注意防范类似的诈骗情形。

您 **不需要** 为正常使用喵窝的服务支付任何费用，我们也 **不会** 以任何理由向您索要钱财。

如果有任何人向您索要钱财，请立刻拒绝并投诉该账号。

喵窝官方运营的账号均设有对应的标志辨识，您可以参考 [官方账号相关资源] 部分的内容进行确认，没有对应标识的账号即非官方所有。如果您有疑问，请 [联系我们] 以进行确认。

[官方账号相关资源]: /brand-assets/#官方账号相关资源
...
喵窝已经可以 [设置并验证您的邮箱地址] 了，可以用于密码找回等操作，所以请保管好您的密码和邮箱信息。请放心，具体的配置内容仅您可见，一般情况下不会被他人获取。
