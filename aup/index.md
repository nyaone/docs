...
本站是一个由爱好者驱动的社区，并非营利性服务，您不得出于任何商业目的注册或使用账号。若有账号被认为是出于商业目的注册使用，涉事账号相关的所有用户会被全部永久封禁，不接受任何申诉。

请注意发送的内容本身的信息价值。如果一个账号长期发送不含价值的信息（例如无意义的乱码，或是监察员认为无法理解其意义的内容），该账号会被认为是滥用公共资源，可能会遭到封禁处理。

每一位加入我们的用户都平等，监察员辅助管理员执行日常站务，不可拥有特权也不得为任何其他用户提供特权。如有因监察员滥用职权引发的失职行为发生，请参照[检举说明](#检举说明)。
...
如果将要发送的消息内容存在争议，请明确标注；如果内容确实来源于可信平台，请附上来源链接的[网站备份](/appendix/#网站备份)，以便其它用户参考查阅。
...
具体法律条文请参见 [服务架构](/service-structure/) 中提及的服务供应商与服务器所在地的相关法律。
...
**因该原因导致封禁的账号不接受任何申诉**，且我们会与身份的原主人尝试取得联系，获得进一步可能可行的解决方案。
...
请注意，关注此类内容的创作者或是与该类内容产生交互（评论、转发等）同样可能导致您的账号被封禁。
...
如果您发现有哪个实例存在大量上述行为，请第一时间与本站监察员联系以考虑中断实例通信；如果您发现有哪位本站用户存在类似行为，同样也麻烦您第一时间与本站监察员联系检举，以避免对联邦宇宙的其他用户或是节点造成误会，甚至带来损失。
...
若有任何侵犯到您著作权益的行为发生，您可以参见[检举说明](#检举说明)与我们取得联系。
...
- 如若您检举的是一般用户行为，您可以利用站内的检举系统将检举内容发送给监察员团队。
- 如若您检举的是监察员行为，请参照[联系我们](/contact/)中的描述向管理员团队发送信息。

### 附带内容

为方便管理团队的判断，请您在检举时附带上以下内容：

1. 原始内容的[网站备份](/appendix/#网站备份)。
